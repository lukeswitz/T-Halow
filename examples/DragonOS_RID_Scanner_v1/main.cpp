...
//
// Serial2 TX and RX pin definitions
#define SERIALTX_AH_RXD 4  // RX pin for Serial2
#define SERIALTX_AH_TXD 5  // TX pin for Serial2

// LED pin definition
#define BOARD_LED 38 // Running status light

// Alias Serial and Serial2
#define SerialMon Serial     // Alias Serial for debugging
#define SerialTX_AH Serial2  // Alias Serial2 for communication
...
static const char        *title = "DragonOS RID Scanner", *build_date = __DATE__,
                         *blank_latlong = " ---.------";
...
#warning "Align MAX_UAVS and colour assignments."
  ...
  // Setup the LED task and serial ports
  setup_serial();
